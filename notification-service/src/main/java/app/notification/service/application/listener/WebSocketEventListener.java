...
public class WebSocketEventListener {
    ...
    public void onUserDisconnect(SessionDisconnectEvent event) {
        ...
        if(accessor.getSessionAttributes() != null && accessor.getSessionAttributes().get("userId") != null) {
            String userId = (String) accessor.getSessionAttributes().get("userId");

            UserStatusDto userStatusDto = new UserStatusDto(Long.valueOf(userId), false);
